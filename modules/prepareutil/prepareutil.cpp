...
void PrepareUtil::setUsingDarkTheme(bool usingDarkTheme)
{
    ...
    if (usingDarkTheme) {
        QProcess::execute(u"plasma-apply-lookandfeel"_s, {QStringLiteral("--apply"), QStringLiteral("EvernightVista-Dark")});
    } else {
        QProcess::execute(u"plasma-apply-lookandfeel"_s, {QStringLiteral("--apply"), QStringLiteral("EvernightVista")});
    }
